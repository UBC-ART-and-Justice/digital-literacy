...
![Annotated email inbox](/course/5-communication/email-inbox.png){ width="97%" }
...
![Spam folder shown in email inbox side menu.](/course/5-communication/spam-folder.png){width=70% style="display: block; margin: 0 auto" }
...
![The recipients of an email, annotated.](/course/5-communication/email-recipients.png){ width="97%"  }
...
![A draft email with recipients, subject, greeting, body, closing, and signature.](/course/5-communication/email-draft.png){ width="97%" }
...
![A draft email with recipients, subject, greeting, body, closing, and signature.](/course/5-communication/email-reply-options.png){ width="97%" }
