...
![Example texting conversation](../../course/5-communication/text-conversation1.png){ width="100%" }

![Another example texting conversation](../../course/5-communication/text-conversation2.png){ width="100%" }
...
![Another example texting conversation](../../course/5-communication/emojis.png){ width="100%" }
